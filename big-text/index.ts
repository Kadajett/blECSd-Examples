...
async function main(): Promise<void> {
	...
	const title = await createBigText(world, addEntity(world) as Entity, {
		left: leftColumn,
		top: titleTop,
		text: titleText,
		font: boldFont,
	...
	const subtitle = await createBigText(world, addEntity(world) as Entity, {
		left: leftColumn,
		top: subtitleTop,
		text: subtitleText,
		font: normalFont,
	...
	const multiLine = await createBigText(world, addEntity(world) as Entity, {
		left: rightColumn,
		top: multiLineTop,
		text: multiLineText,
		font: boldFont,
	...
	const accents = await createBigText(world, addEntity(world) as Entity, {
		left: rightColumn,
		top: accentsTop,
		text: accentsText,
		font: normalFont,
	...
	const outline = await createBigText(world, addEntity(world) as Entity, {
		left: leftColumn,
		top: outlineTop,
		text: outlineText,
		font: normalFont,
